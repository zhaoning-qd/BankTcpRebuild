...
namespace BDJX.BSCP.BLL
{
    ...
    /// 网厅贷款--结算交易日终对账
    /// </summary>
    public class WtDaikuanjiesuanRizhongduizhang :IWtDaikuanjiesuanRizhongduizhang
    {
        /// <summary>
        /// 请求报文实体
        /// </summary>
        WtdkjsrzdzModel model;

        /// <summary>
        /// 响应报文实体
        /// </summary>
        WtdkjsrzdzMsgModel modelMsg;
        ...
        /// 构造函数
        /// </summary>
        public WtDaikuanjiesuanRizhongduizhang()
        {
            model = new WtdkjsrzdzModel();
            modelMsg = new WtdkjsrzdzMsgModel();
