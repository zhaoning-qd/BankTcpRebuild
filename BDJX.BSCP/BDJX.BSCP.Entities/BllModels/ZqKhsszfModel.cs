...
namespace BDJX.BSCP.Entities.BllModels
{
    ...
    public class ZqKhsszfModel
    {
        ...
        public void GetValue(byte[] recvBytes)
        {
            ...
            this.Skyhmc = BasicOperation.GetStringFromRequestMsg(recvBytes, 264, 60);
            this.Skrkhhh = BasicOperation.GetStringFromRequestMsg(recvBytes, 324, 12);
            this.Je = BasicOperation.GetStringFromRequestMsg(recvBytes, 336, 12);
            this.Beiz = BasicOperation.GetStringFromRequestMsg(recvBytes, 348, 60);
        }
    }
}
